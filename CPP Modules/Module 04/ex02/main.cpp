...
int	main( void )
{
	...
	std::cout << "────────────────────────────────────────────────────────" << std::endl;
	std::cout << ANSI_COLOR_BBLUE << tab[0]->getType() << ANSI_RESET
	<< ": " << tab[0]->get_brain()->ideas[0] << std::endl;
	*(tab[1]) = *(tab[0]);
	std::cout << ANSI_COLOR_BBLUE << tab[1]->getType() << ANSI_RESET
	<< ": " << tab[1]->get_brain()->ideas[1] << std::endl;
	std::cout << "────────────────────────────────────────────────────────" << std::endl;
	std::cout << ANSI_COLOR_BYELLOW << tab[2]->getType() << ANSI_RESET
	<< ": " << tab[2]->get_brain()->ideas[2] << std::endl;
	*(tab[3]) = *(tab[2]);
	std::cout << ANSI_COLOR_BYELLOW << tab[3]->getType() << ANSI_RESET
	<< ": " << tab[3]->get_brain()->ideas[3] << std::endl;
	std::cout << "────────────────────────────────────────────────────────" << std::endl;
